package org.sunyata.game.edy.ai.core.util.complex;//package com.xt.landlords.ai.core.util.complex;
//
//import java.util.*;
...
//		Hand hand = new Hand(HandType.SOLO, lowestControl, 1, null);
//		if (solosList.contains(hand)) {
//			return summary1;
//		}
...
//						Set<Entry<HandType, List<Hand>>> entrySet = lordHandMap.entrySet();
//						int maxCount = 0;
//						Hand minHand = null;
//						for (Entry<HandType, List<Hand>> entry : entrySet) {
//							HandType type = entry.getKey();
...
//							bombs.addAll(AIUtils.getAllBomb(upCards));
//							bombs.addAll(AIUtils.getAllBomb(downCards));
//							for (int i = 0; i < bombs.size(); i++) {
//								Hand hand2 = bombs.get(i);
