...
public class EliminatePlayPhaseDataItem extends PhaseData {
    ...
    private String hitJackpotMoney;
    ...
    public void setHitJackpot(boolean hitJackpot) {
        this.hitJackpot = hitJackpot;
    }

    public boolean isHitJackpot() {
        return hitJackpot;
    }

    public void setHitJackpotMoney(String hitJackpotMoney) {
        this.hitJackpotMoney = hitJackpotMoney;
    }

    public String getHitJackpotMoney() {
        return hitJackpotMoney;
    }
}